...
<head>
  ...
  <title>Uith ECC Medical Health Care</title>
...
<body>
  ...
  <div id="topbar" class="d-flex align-items-center fixed-top">
    <div class="container d-flex justify-content-between">
      <div class="contact-info d-flex align-items-center">
        <i class="bi bi-envelope"></i> <a href="mailto:khaeraholamide@gmail.com">khaeraholamide@gmail.com</a>
        <i class="bi bi-phone"></i> 07050925570
      </div>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="#home">Uith<img src="assets/img/logo.png" /> </a></h1>
  ...
  <section id="home" style="margin-top: 5rem;">
    <div class="container">
      <div class="row">
        ...
        <div class="row align-items-center content flex-lg-row">
          <div class="col-lg-6 pr-md-4 overflow-hidden-all">
  ...
  <main id="main">
              ...
              <div class="row">
                <div class="col-xl-4 d-flex align-items-stretch">
                  <div class="icon-box mt-4 mt-xl-0">
                    ...
                    <h4>Modern Clinic</h4>
                    <p>Our hospitals are equipped with sophisticated contemporary machines to cater for you health needs.</p>
                  </div>
                </div>
                <div class="col-xl-4 d-flex align-items-stretch">
                  <div class="icon-box mt-4 mt-xl-0">
                    ...
                    <p>We take pride in having a number of qualified Doctors who are experienced and qualified.</p>
                  </div>
                </div>
                <div class="col-xl-4 d-flex align-items-stretch">
                  <div class="icon-box mt-4 mt-xl-0">
                    ...
                    <h4>Emergency</h4>
                    <p>Our rapid response to critical health matters has made us one of the leading hospitals in Nigeria.</p>
                  </div>
                </div>
              </div>
            </div><!-- End .content-->
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-xl-5 col-lg-6 video-box d-flex justify-content-center align-items-stretch position-relative">
            <a href="https://www.youtube.com/watch?v=pc1jlelzmPY" class="glightbox play-btn mb-4"></a>
          </div>

          <div class="col-xl-7 col-lg-6 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5">
            <h3>Personal care at your fingertips</h3>
    ...
    <section id="services" class="services">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Services</h2>
          <p>Uith offers a broad range of services, we focus on specific area of medicine. The providers in a specialized clinic will have specific training that focuses on medical fields such as:</p>
        </div>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
            <div class="icon-box">
              ...
              <h4><a href="">Community health centers</a></h4>
              <p>A community health center is a type of clinic that’s community-directed and supported by federal funding.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
            <div class="icon-box">
              ...
              <h4><a href="">Rural health clinics</a></h4>
              <p>The goal of the rural health clinic program is to provide better access to care in rural, underserved communities.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0">
            <div class="icon-box">
              ...
              <h4><a href="">Routine health screenings</a></h4>
              <p>Depending on age, doctors will recommend a screening schedule that includes regular physical exams.</p>
            </div>
          </div>
    ...
    <section id="appointment" class="appointment section-bg">
      <div class="container">
        ...
        <div class="section-title">
          ...
          <p>Patients requesting appointments will be assessed to determine the care option to best meet their need, including video and in-person appointments.</p>
        </div>
        ...
        <form action="" method="post" role="form" class="php-email-form">
          <div class="row">
            ...
            <div class="col-md-4 form-group mt-3 mt-md-0">
              <input type="number" name="tel" class="form-control" placeholder="Enter your phone number e.g 070 *****" />
            </div>
            <div class="col-md-4 form-group mt-3 mt-md-0">
          ...
          <div class="form-group mt-3">
            <textarea class="form-control" name="message" rows="5" placeholder="Kindly lodge your complaint"></textarea>
          </div>
    ...
    <section id="departments" class="departments">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Departments</h2>
          <p>Hospitals vary widely in the services they offer and therefore, in the departments they have. We have acute services such as an emergency department or specialist trauma center, burn unit, surgery, urgent care, cardiology or coronary care unit, intensive care unit, neurology, cancer center, and obstetrics and gynecology.</p>
        </div>
        ...
        <div class="row gy-4">
          <div class="col-lg-3">
            <ul class="nav nav-tabs flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#tab-5">Ophthalmologists</a>
              </li>
            </ul>
          </div>
          <div class="col-lg-9">
            <div class="tab-content">
              ...
              <div class="tab-pane" id="tab-3">
                <div class="row gy-4">
                  <div class="col-lg-8 details order-2 order-lg-1">
                    <h3>Hepatology</h3>
                    <p class="fst-italic">The term hepatology is derived from the Greek words “hepatikos” and “logia,” which mean liver and study, respectively.</p>
              ...
              <div class="tab-pane" id="tab-4">
                <div class="row gy-4">
                  <div class="col-lg-8 details order-2 order-lg-1">
                    <h3>Pediatric</h3>
                    <p class="fst-italic">Pediatrics is the specialty of medical science concerned with the physical, mental, and social health of children from birth to young adulthood.</p>
                    <p>
                       Pediatric care encompasses a broad spectrum of health services ranging from preventive health care to the diagnosis and treatment of acute and chronic diseases.</p>
                  </div>
                  <div class="col-lg-4 text-center order-1 order-lg-2">
              ...
              <div class="tab-pane" id="tab-5">
                <div class="row gy-4">
                  <div class="col-lg-8 details order-2 order-lg-1">
                    ...
                    <p class="fst-italic">Ophthalmologists are trained to perform eye tests, diagnose and treat disease, prescribe medications and perform eye surgery.</p>
                    <p>Early treatment is critically important to prevent some common eye diseases from causing permanent vision loss or blindness: Cataracts (clouding of the lens), the leading cause of vision loss</p>
                  </div>
                  <div class="col-lg-4 text-center order-1 order-lg-2">
    ...
    <section id="faq" class="faq section-bg">
      <div class="container">
        ...
        <div class="faq-list">
          <ul>
            <li data-aos="fade-up">
              <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" class="collapse" data-bs-target="#faq-list-1">Is my microwave giving me cancer? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
            ...
            <li data-aos="fade-up" data-aos-delay="100">
              <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-2" class="collapsed">How long am I contagious when I have the flu or a cold?<i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
            ...
            <li data-aos="fade-up" data-aos-delay="200">
              <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-3" class="collapsed">Can I trust my tap water? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
            ...
            <li data-aos="fade-up" data-aos-delay="300">
              <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-4" class="collapsed">Will vitamin D save my life? Should I really be taking four times the recommended daily dose? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
            ...
            <li data-aos="fade-up" data-aos-delay="400">
              <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-5" class="collapsed">Sugar or High Fructose Corn Syrup?<i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
    ...
    <section id="location" >
      <div class="container">
        ...
        <div class="section-title">
          <h2>Contact</h2>
          <p>Uith care teams blend multidisciplinary skills, focusing several people's insights, rather than a single physician's, on each patient's problems. For feedback regarding your experience with this project, please contact the researcher via <a href="https://api.whatsapp.com/send/?phone=2347050925570&text=Hello+ Khaira&app_absent=0">Whatsapp </a>.</p>
        </div>
      </div>

      <div>
        <iframe style="border:0; width: 100%; height: 350px;" src="https://maps.google.com/maps?q=university%20of%20ilorin%20teaching%20hospital&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" allowfullscreen></iframe>
      </div>
  ...
  <footer id="footer">
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="me-md-auto text-center">
        <div class="copyright">
          &copy; Copyright <strong><span>UITH</span></strong>. All Rights Reserved
        </div>
      </div>
    </div>
  </footer><!-- End Footer -->
